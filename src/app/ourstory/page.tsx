        ...
        <div className="relative h-svh md:min-h-screen w-full bg-[url('../app/asset/heroimage2.webp')] bg-cover bg-center bg-no-repeat">
          ...
          <div className="absolute inset-0 bg-gradient-to-tl from-black/90 to-black/40 flex items-center justify-center">
            ...
            >
              ...
              {/* <div className="mt-3 md:mt-10 text-xl md:text-3xl text-white font-averia">
                Crafting Connection Through Coffee
              </div> */}

              <div className="mt-5 md:mt-6 max-w-md md:max-w-4xl tracking-wide text-sm md:text-xl leading-relaxed text-center text-white">
